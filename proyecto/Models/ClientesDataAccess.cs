		...
		public Clientes ConsultarClientes()
		{
			...
			try
			{
				...
				while (rdr.Read())
				{
					...
					_Clientes.codigoclienteprincipal = !rdr.IsDBNull(1) ? Convert.ToString(rdr["codigoclienteprincipal"].ToString()) : "";
					_Clientes.iddocumentoidentidad = !rdr.IsDBNull(2) ? Convert.ToInt16(rdr["iddocumentoidentidad"].ToString()) : (System.Int16)0;
					_Clientes.numerodocumento = !rdr.IsDBNull(3) ? Convert.ToString(rdr["numerodocumento"].ToString()) : "";
					...
					_Clientes.telefono = !rdr.IsDBNull(10) ? Convert.ToString(rdr["telefono"].ToString()) : "";
